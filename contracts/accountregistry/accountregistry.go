...
func (_Accountregistry *AccountregistryCaller) Exists(opts *bind.CallOpts, accountIndex *big.Int, pubkey [4]*big.Int, witness [31][32]byte) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _Accountregistry.contract.Call(opts, out, "exists", accountIndex, pubkey, witness)
	return *ret0, err
}
...
//
// Solidity: function exists(uint256 accountIndex, uint256[4] pubkey, bytes32[31] witness) view returns(bool)
func (_Accountregistry *AccountregistrySession) Exists(accountIndex *big.Int, pubkey [4]*big.Int, witness [31][32]byte) (bool, error) {
	return _Accountregistry.Contract.Exists(&_Accountregistry.CallOpts, accountIndex, pubkey, witness)
}

// Exists is a free data retrieval call binding the contract method 0x709a8b2a.
//
// Solidity: function exists(uint256 accountIndex, uint256[4] pubkey, bytes32[31] witness) view returns(bool)
func (_Accountregistry *AccountregistryCallerSession) Exists(accountIndex *big.Int, pubkey [4]*big.Int, witness [31][32]byte) (bool, error) {
	return _Accountregistry.Contract.Exists(&_Accountregistry.CallOpts, accountIndex, pubkey, witness)
}
...
func (_Accountregistry *AccountregistryTransactor) RegisterBatch(opts *bind.TransactOpts, pubkeys [1024][4]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function registerBatch(uint256[4][1024] pubkeys) returns(uint256)
func (_Accountregistry *AccountregistrySession) RegisterBatch(pubkeys [1024][4]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function registerBatch(uint256[4][1024] pubkeys) returns(uint256)
func (_Accountregistry *AccountregistryTransactorSession) RegisterBatch(pubkeys [1024][4]*big.Int) (*types.Transaction, error) {
	return _Accountregistry.Contract.RegisterBatch(&_Accountregistry.TransactOpts, pubkeys)
}
