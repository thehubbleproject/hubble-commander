...
//
// Solidity: function deposit(address beneficiary) payable returns()
func (_Burnauction *BurnauctionTransactor) Deposit(opts *bind.TransactOpts, beneficiary common.Address) (*types.Transaction, error) {
	return _Burnauction.contract.Transact(opts, "deposit", beneficiary)
}

// Deposit is a paid mutator transaction binding the contract method 0xf340fa01.
//
// Solidity: function deposit(address beneficiary) payable returns()
func (_Burnauction *BurnauctionSession) Deposit(beneficiary common.Address) (*types.Transaction, error) {
	return _Burnauction.Contract.Deposit(&_Burnauction.TransactOpts, beneficiary)
}

// Deposit is a paid mutator transaction binding the contract method 0xf340fa01.
//
// Solidity: function deposit(address beneficiary) payable returns()
func (_Burnauction *BurnauctionTransactorSession) Deposit(beneficiary common.Address) (*types.Transaction, error) {
	return _Burnauction.Contract.Deposit(&_Burnauction.TransactOpts, beneficiary)
}
