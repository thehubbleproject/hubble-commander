...
// VerifySingle is a free data retrieval call binding the contract method 0x9cd5c076.
//
// Solidity: function verifySingle(bytes encodedTx, uint256[2] signature, uint256[4] pubkeySender, bytes32 domain) view returns()
func (_Create2transfer *Create2transferCaller) VerifySingle(opts *bind.CallOpts, encodedTx []byte, signature [2]*big.Int, pubkeySender [4]*big.Int, domain [32]byte) error {
	var ()
	out := &[]interface{}{}
	err := _Create2transfer.contract.Call(opts, out, "verifySingle", encodedTx, signature, pubkeySender, domain)
	return err
}
...
//
// Solidity: function verifySingle(bytes encodedTx, uint256[2] signature, uint256[4] pubkeySender, bytes32 domain) view returns()
func (_Create2transfer *Create2transferSession) VerifySingle(encodedTx []byte, signature [2]*big.Int, pubkeySender [4]*big.Int, domain [32]byte) error {
	return _Create2transfer.Contract.VerifySingle(&_Create2transfer.CallOpts, encodedTx, signature, pubkeySender, domain)
}

// VerifySingle is a free data retrieval call binding the contract method 0x9cd5c076.
//
// Solidity: function verifySingle(bytes encodedTx, uint256[2] signature, uint256[4] pubkeySender, bytes32 domain) view returns()
func (_Create2transfer *Create2transferCallerSession) VerifySingle(encodedTx []byte, signature [2]*big.Int, pubkeySender [4]*big.Int, domain [32]byte) error {
	return _Create2transfer.Contract.VerifySingle(&_Create2transfer.CallOpts, encodedTx, signature, pubkeySender, domain)
}
