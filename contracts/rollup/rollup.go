...
// ApplyTx is a free data retrieval call binding the contract method 0x2108cff8.
//
...
// ProcessBatch is a free data retrieval call binding the contract method 0x7d3fe0b8.
//
...
// ProcessTx is a free data retrieval call binding the contract method 0xe8a38c7e.
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
func (_Rollup *RollupCaller) ProcessTx(opts *bind.CallOpts, _balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, []byte, []byte, uint8, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([]byte)
		ret2 = new([]byte)
	...
	err := _Rollup.contract.Call(opts, out, "processTx", _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, accountProofs)
...
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
func (_Rollup *RollupSession) ProcessTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, []byte, []byte, uint8, bool, error) {
	return _Rollup.Contract.ProcessTx(&_Rollup.CallOpts, _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, accountProofs)
}

// ProcessTx is a free data retrieval call binding the contract method 0xe8a38c7e.
//
// Solidity: function processTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, TypesPDAMerkleProof _from_pda_proof, TypesAccountProofs accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
func (_Rollup *RollupCallerSession) ProcessTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, accountProofs TypesAccountProofs) ([32]byte, []byte, []byte, uint8, bool, error) {
	return _Rollup.Contract.ProcessTx(&_Rollup.CallOpts, _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, accountProofs)
}
...
// DisputeBatch is a paid mutator transaction binding the contract method 0xdcd4e4b6.
//
