...
// CommitmentToHash is a free data retrieval call binding the contract method 0x96db5145.
//
// Solidity: function CommitmentToHash(bytes32 stateRoot, bytes32 accountRoot, bytes32 txCommitment, bytes32 txRoot, uint8 batchType) pure returns(bytes32)
func (_Rolluputils *RolluputilsCaller) CommitmentToHash(opts *bind.CallOpts, stateRoot [32]byte, accountRoot [32]byte, txCommitment [32]byte, txRoot [32]byte, batchType uint8) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
	err := _Rolluputils.contract.Call(opts, out, "CommitmentToHash", stateRoot, accountRoot, txCommitment, txRoot, batchType)
	return *ret0, err
}
...
//
// Solidity: function CommitmentToHash(bytes32 stateRoot, bytes32 accountRoot, bytes32 txCommitment, bytes32 txRoot, uint8 batchType) pure returns(bytes32)
func (_Rolluputils *RolluputilsSession) CommitmentToHash(stateRoot [32]byte, accountRoot [32]byte, txCommitment [32]byte, txRoot [32]byte, batchType uint8) ([32]byte, error) {
	return _Rolluputils.Contract.CommitmentToHash(&_Rolluputils.CallOpts, stateRoot, accountRoot, txCommitment, txRoot, batchType)
}

// CommitmentToHash is a free data retrieval call binding the contract method 0x96db5145.
//
// Solidity: function CommitmentToHash(bytes32 stateRoot, bytes32 accountRoot, bytes32 txCommitment, bytes32 txRoot, uint8 batchType) pure returns(bytes32)
func (_Rolluputils *RolluputilsCallerSession) CommitmentToHash(stateRoot [32]byte, accountRoot [32]byte, txCommitment [32]byte, txRoot [32]byte, batchType uint8) ([32]byte, error) {
	return _Rolluputils.Contract.CommitmentToHash(&_Rolluputils.CallOpts, stateRoot, accountRoot, txCommitment, txRoot, batchType)
}
