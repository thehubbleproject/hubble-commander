...
//
// Solidity: function processAirdropTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes sig, bytes txBytes, ((uint256,(bytes)),bytes32[]) _from_pda_proof, (((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[])) accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
...
// ProcessBatch is a free data retrieval call binding the contract method 0x8128fa49.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, bytes[] signatures, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessBatch(opts *bind.CallOpts, initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([32]byte)
		ret2 = new(bool)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processBatch", initialStateRoot, accountsRoot, txs, signatures, batchProofs, expectedTxRoot, batchType)
...
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, bytes[] signatures, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, signatures, batchProofs, expectedTxRoot, batchType)
}

// ProcessBatch is a free data retrieval call binding the contract method 0x8128fa49.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, bytes[] signatures, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, signatures, batchProofs, expectedTxRoot, batchType)
}

// ProcessBurnConsentTx is a free data retrieval call binding the contract method 0x8fec478c.
//
// Solidity: function processBurnConsentTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes sig, bytes txBytes, ((uint256,(bytes)),bytes32[]) _from_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _fromAccountProof) view returns(bytes32, bytes, uint8, bool)
...
// ProcessCreateAccountTx is a free data retrieval call binding the contract method 0x3e04c102.
//
// Solidity: function processCreateAccountTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(bytes)),bytes32[]) _to_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) to_account_proof) view returns(bytes32 newRoot, bytes createdAccountBytes, uint8, bool)
...
//
// Solidity: function processTransferTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes sig, bytes txBytes, ((uint256,(bytes)),bytes32[]) _from_pda_proof, (((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[])) accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
