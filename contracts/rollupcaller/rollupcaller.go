...
// ProcessBatch is a free data retrieval call binding the contract method 0x23e30be7.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessBatch(opts *bind.CallOpts, initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([32]byte)
		ret2 = new(bool)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processBatch", initialStateRoot, accountsRoot, txs, batchProofs, expectedTxRoot, batchType)
...
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, batchProofs, expectedTxRoot, batchType)
}

// ProcessBatch is a free data retrieval call binding the contract method 0x23e30be7.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(bytes)),bytes32[])[]) batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, batchProofs, expectedTxRoot, batchType)
}
