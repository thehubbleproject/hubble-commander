...
//
// Solidity: function ApplyAirdropTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof, bytes txBytes) view returns(bytes, bytes32 newRoot)
...
//
// Solidity: function ApplyBurnConsentTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof, bytes txBytes) view returns(bytes updatedAccount, bytes32 newRoot)
...
// ApplyBurnExecutionTx is a free data retrieval call binding the contract method 0x4d68c580.
//
// Solidity: function ApplyBurnExecutionTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof) view returns(bytes updatedAccount, bytes32 newRoot)
func (_Rollupcaller *RollupcallerCaller) ApplyBurnExecutionTx(opts *bind.CallOpts, _merkle_proof TypesAccountMerkleProof) (struct {
	UpdatedAccount []byte
	NewRoot        [32]byte
}, error) {
	ret := new(struct {
	...
	out := ret
	err := _Rollupcaller.contract.Call(opts, out, "ApplyBurnExecutionTx", _merkle_proof)
	return *ret, err
}
...
//
// Solidity: function ApplyBurnExecutionTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof) view returns(bytes updatedAccount, bytes32 newRoot)
func (_Rollupcaller *RollupcallerSession) ApplyBurnExecutionTx(_merkle_proof TypesAccountMerkleProof) (struct {
	UpdatedAccount []byte
	NewRoot        [32]byte
}, error) {
	return _Rollupcaller.Contract.ApplyBurnExecutionTx(&_Rollupcaller.CallOpts, _merkle_proof)
}

// ApplyBurnExecutionTx is a free data retrieval call binding the contract method 0x4d68c580.
//
// Solidity: function ApplyBurnExecutionTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof) view returns(bytes updatedAccount, bytes32 newRoot)
func (_Rollupcaller *RollupcallerCallerSession) ApplyBurnExecutionTx(_merkle_proof TypesAccountMerkleProof) (struct {
	UpdatedAccount []byte
	NewRoot        [32]byte
}, error) {
	return _Rollupcaller.Contract.ApplyBurnExecutionTx(&_Rollupcaller.CallOpts, _merkle_proof)
...
//
// Solidity: function ApplyCreateAccountTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof, bytes txBytes) view returns(bytes, bytes32 newRoot)
...
//
// Solidity: function ApplyTransferTx(((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _merkle_proof, bytes txBytes) view returns(bytes, bytes32 newRoot)
...
// ProcessAirdropTx is a free data retrieval call binding the contract method 0xa142e90a.
//
// Solidity: function processAirdropTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes sig, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _from_pda_proof, (((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[])) accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
...
// ProcessBatch is a free data retrieval call binding the contract method 0x4fa052b9.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(uint256[4])),bytes32[])[]) batchProofs, bytes32 expectedTxHashCommitment, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessBatch(opts *bind.CallOpts, initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxHashCommitment [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([32]byte)
		ret2 = new(bool)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processBatch", initialStateRoot, accountsRoot, txs, batchProofs, expectedTxHashCommitment, batchType)
...
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(uint256[4])),bytes32[])[]) batchProofs, bytes32 expectedTxHashCommitment, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxHashCommitment [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, batchProofs, expectedTxHashCommitment, batchType)
}

// ProcessBatch is a free data retrieval call binding the contract method 0x4fa052b9.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes txs, ((((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]))[],((uint256,(uint256[4])),bytes32[])[]) batchProofs, bytes32 expectedTxHashCommitment, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, txs []byte, batchProofs TypesBatchValidationProofs, expectedTxHashCommitment [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, txs, batchProofs, expectedTxHashCommitment, batchType)
}

// ProcessBurnConsentTx is a free data retrieval call binding the contract method 0xdeb2a5de.
//
// Solidity: function processBurnConsentTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _from_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _fromAccountProof) view returns(bytes32, bytes, uint8, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessBurnConsentTx(opts *bind.CallOpts, _balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, _fromAccountProof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([]byte)
		ret2 = new(uint8)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processBurnConsentTx", _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, _fromAccountProof)
...
//
// Solidity: function processBurnConsentTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _from_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _fromAccountProof) view returns(bytes32, bytes, uint8, bool)
func (_Rollupcaller *RollupcallerSession) ProcessBurnConsentTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, _fromAccountProof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	return _Rollupcaller.Contract.ProcessBurnConsentTx(&_Rollupcaller.CallOpts, _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, _fromAccountProof)
}

// ProcessBurnConsentTx is a free data retrieval call binding the contract method 0xdeb2a5de.
//
// Solidity: function processBurnConsentTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _from_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _fromAccountProof) view returns(bytes32, bytes, uint8, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessBurnConsentTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _from_pda_proof TypesPDAMerkleProof, _fromAccountProof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	return _Rollupcaller.Contract.ProcessBurnConsentTx(&_Rollupcaller.CallOpts, _balanceRoot, _accountsRoot, txBytes, _from_pda_proof, _fromAccountProof)
}

// ProcessBurnExecutionTx is a free data retrieval call binding the contract method 0x3c697977.
//
// Solidity: function processBurnExecutionTx(bytes32 _balanceRoot, bytes txBytes, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) _fromAccountProof) view returns(bytes32, bytes, uint8, bool)
...
// ProcessCreateAccountTx is a free data retrieval call binding the contract method 0x6edd1d14.
//
// Solidity: function processCreateAccountTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _to_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) to_account_proof) view returns(bytes32 newRoot, bytes createdAccountBytes, uint8, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessCreateAccountTx(opts *bind.CallOpts, _balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _to_pda_proof TypesPDAMerkleProof, to_account_proof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([]byte)
		ret2 = new(uint8)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processCreateAccountTx", _balanceRoot, _accountsRoot, txBytes, _to_pda_proof, to_account_proof)
	return *ret0, *ret1, *ret2, *ret3, err
}
...
//
// Solidity: function processCreateAccountTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _to_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) to_account_proof) view returns(bytes32 newRoot, bytes createdAccountBytes, uint8, bool)
func (_Rollupcaller *RollupcallerSession) ProcessCreateAccountTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _to_pda_proof TypesPDAMerkleProof, to_account_proof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	return _Rollupcaller.Contract.ProcessCreateAccountTx(&_Rollupcaller.CallOpts, _balanceRoot, _accountsRoot, txBytes, _to_pda_proof, to_account_proof)
}

// ProcessCreateAccountTx is a free data retrieval call binding the contract method 0x6edd1d14.
//
// Solidity: function processCreateAccountTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _to_pda_proof, ((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]) to_account_proof) view returns(bytes32 newRoot, bytes createdAccountBytes, uint8, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessCreateAccountTx(_balanceRoot [32]byte, _accountsRoot [32]byte, txBytes []byte, _to_pda_proof TypesPDAMerkleProof, to_account_proof TypesAccountMerkleProof) ([32]byte, []byte, uint8, bool, error) {
	return _Rollupcaller.Contract.ProcessCreateAccountTx(&_Rollupcaller.CallOpts, _balanceRoot, _accountsRoot, txBytes, _to_pda_proof, to_account_proof)
}

// ProcessTransferTx is a free data retrieval call binding the contract method 0xb20421b7.
//
// Solidity: function processTransferTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes sig, bytes txBytes, ((uint256,(uint256[4])),bytes32[]) _from_pda_proof, (((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[]),((uint256,(uint256,uint256,uint256,uint256,uint256,uint256)),bytes32[])) accountProofs) view returns(bytes32, bytes, bytes, uint8, bool)
