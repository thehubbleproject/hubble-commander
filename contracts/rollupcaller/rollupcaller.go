...
// ProcessBatch is a free data retrieval call binding the contract method 0x30fb4014.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes[] _txs, bytes[] signatures, TypesBatchValidationProofs batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCaller) ProcessBatch(opts *bind.CallOpts, initialStateRoot [32]byte, accountsRoot [32]byte, _txs [][]byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	var (
		ret0 = new([32]byte)
		ret1 = new([32]byte)
		ret2 = new(bool)
	...
	err := _Rollupcaller.contract.Call(opts, out, "processBatch", initialStateRoot, accountsRoot, _txs, signatures, batchProofs, expectedTxRoot, batchType)
...
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes[] _txs, bytes[] signatures, TypesBatchValidationProofs batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, _txs [][]byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, _txs, signatures, batchProofs, expectedTxRoot, batchType)
}

// ProcessBatch is a free data retrieval call binding the contract method 0x30fb4014.
//
// Solidity: function processBatch(bytes32 initialStateRoot, bytes32 accountsRoot, bytes[] _txs, bytes[] signatures, TypesBatchValidationProofs batchProofs, bytes32 expectedTxRoot, uint8 batchType) view returns(bytes32, bytes32, bool)
func (_Rollupcaller *RollupcallerCallerSession) ProcessBatch(initialStateRoot [32]byte, accountsRoot [32]byte, _txs [][]byte, signatures [][]byte, batchProofs TypesBatchValidationProofs, expectedTxRoot [32]byte, batchType uint8) ([32]byte, [32]byte, bool, error) {
	return _Rollupcaller.Contract.ProcessBatch(&_Rollupcaller.CallOpts, initialStateRoot, accountsRoot, _txs, signatures, batchProofs, expectedTxRoot, batchType)
}
...
//
// Solidity: function processCreateAccountTx(bytes32 _balanceRoot, bytes32 _accountsRoot, bytes txBytes, TypesPDAMerkleProof _to_pda_proof, TypesAccountMerkleProof to_account_proof) view returns(bytes32 newRoot, bytes createdAccountBytes, uint8, bool)
