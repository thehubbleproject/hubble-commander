...
func TestTransferBody(t *testing.T) {
	...
	// bytes32 accountRoot
	accountRoot := "3a53dc4890241dbe03e486e785761577d1c369548f6b09aa38017828dcdf5c27"
	...
	signature[0] = StringToBigInt(signatures[0])
	signature[1] = StringToBigInt(signatures[1])
